...
export default function Header() {
    ...
    return (
        <header className='flex justify-between'>
            ...
            <div className="hidden md:flex shadow-md shadow-gray-300 gap-2 py-2 px-4 border border-gray-300 rounded-full">
                <div>Anywhere</div>
            ...
            <Link to={user ? '/account':'/login'} className='flex gap-2 py-2 items-center px-4 border border-gray-300 rounded-full'>
